...
//             $('#length-req').removeClass('valid').addClass('invalid');
//             isValid = false;
//         } else {
//             $('#length-req').removeClass('invalid').addClass('valid');
//         }

//         // Validar que las contraseñas coincidan
//         if (newPassword !== confirmPassword || !confirmPassword) {
//             $('#match-req').removeClass('valid').addClass('invalid');
//             isValid = false;
//         } else {
//             $('#match-req').removeClass('invalid').addClass('valid');
//         }

//         // Validar que sea diferente a la actual
//         if (currentPassword === newPassword || !newPassword) {
//             $('#different-req').removeClass('valid').addClass('invalid');
//             isValid = false;
//         } else {
//             $('#different-req').removeClass('invalid').addClass('valid');
//         }
...
//         $('.password-requirements li').removeClass('valid invalid');
...
//         const submitBtn = $('#passwordChangeModal .btn-primary');
//         setButtonLoading(submitBtn, true);
...
$(document).ready(function() {
    ...
    function initializeEventListeners() {
        ...
        // Modal confirmación número
        $('#confirmModal .btn-primary').on('click', confirmarEleccion);

        // FORMULARIO CAMBIO DE CONTRASEÑA - NUEVO
        $('#changePasswordForm').on('submit', handleChangePassword);

        // Validación en tiempo real para contraseñas - NUEVO
        $('#new_password, #confirm_password, #current_password').on('input', validatePasswordForm);
    ...
    function showTab(tabName) {
        ...
        if (tabName === 'mis-numeros') {
            ...
            loadHistorial();
        } else if (tabName === 'cambiar-password') {
            resetPasswordForm();
        }
    }
    ...
    function handleChangePassword(e) {
        ...
        if (!validatePasswordForm()) {
            showAlert('Por favor completa correctamente todos los campos', 'warning');
            return;
        }
